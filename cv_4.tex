...
\name{Robert Karmazin} % Your name
\address{100 Graham Road Apt 7H \\ Ithaca, NY 14850} % Your address
\address{(631)~258~8961 \\ rob@csl.cornell.edu} % Your phone number and email

\addbibresource{citations.bib} % Specify the bibliography file to include publications
\begin{document}
...
\printbibsection{}{} % Print all articles from the bibliography
